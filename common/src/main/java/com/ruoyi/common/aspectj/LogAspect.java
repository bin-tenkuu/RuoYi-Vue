...
public class LogAspect {
    ...
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, SysOperLog operLog, Object jsonResult) {
        ...
        if (log.isSaveResponseData()) {
            if (jsonResult != null) {
                operLog.setJsonResult(StringUtils.substring(GlobalInstance.toJson(jsonResult), 0, 2000));
            }
        }
    }
    ...
    private void setRequestValue(JoinPoint joinPoint, SysOperLog operLog) {
        ...
        if (StringUtils.isEmpty(paramsMap)
            ...
            operLog.setOperParam(StringUtils.substring(GlobalInstance.toJson(paramsMap), 0, 2000));
        }
    }
        ...
        if (paramsArray != null) {
            for (Object o : paramsArray) {
                if (o != null && !isFilterObject(o)) {
                    try {
                        String jsonObj = GlobalInstance.toJson(o);
