...
import com.ruoyi.common.mapper.SysMenuMapper;
import com.ruoyi.common.mapper.SysRoleMapper;
import com.ruoyi.common.mapper.SysRoleMenuMapper;
import com.ruoyi.common.model.TreeSelect;
import com.ruoyi.common.model.sysmenu.MetaVo;
...
public class SysMenuServiceImpl extends ServiceImpl<SysMenuMapper, SysMenu>
    ...
    public List<RouterVo> buildMenus(List<SysMenu> menus) {
        ...
        for (SysMenu menu : menus) {
            ...
            if (StringUtils.isNotEmpty(cMenus) && UserConstants.TYPE_DIR.equals(menu.getMenuType())) {
                ...
                children.setMeta(
                        new MetaVo(menu.getMenuName(), menu.getIcon(), Objects.equals(1, menu.getIsCache()),
                                menu.getPath()));
    ...
    public boolean checkMenuNameUnique(SysMenu menu) {
        ...
        Long info = baseMapper.checkMenuNameUnique(menu.getMenuName(), menu.getParentId());
        return info == null || info.equals(menuId);
    }
